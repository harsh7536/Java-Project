...
public class PlayerController {
     ...
     */
    // public List<Vote> getAllPlayers() {
    //     try {
    //         return c2w_pi_playerDao.getDataList("Voter"); // Retrieve all players from the "player" collection
     ...
     *         otherwise.
     */
    // public boolean addVoters(Playerr c2w_pi_data) {
    //     try {
    //         c2w_pi_playerDao.addData("parties", c2w_pi_data.getPlayerName(), c2w_pi_data); // Add player to the "player"
    //                                                                                       // collection
